                ...
                <tr>
                    <td style="padding: 40px 20px;">
                        <table role="presentation" style="width: 100%; max-width: 600px; margin: 0 auto; border-collapse: collapse; background-color: ${lightColors.background}; border-radius: 8px; overflow: hidden; border-width: 1px; border-style: solid; border-color: ${lightColors.border}; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);">
                            ...
                            <!-- Security/Action Header Stripe -->
                            <tr>
                                <td style="background-color: ${lightColors.primary}; height: 4px;"></td>
                            </tr>
                            ...
                            <tr>
                                <td style="padding: 40px 30px;">
                                    ...
                                    <p style="color: ${lightColors.textSecondary}; font-size: 14px; line-height: 1.6; margin: 24px 0 8px 0;">
                                        ${t('email.passwordReset.orCopy')}
                                    </p>
                                    <p style="margin: 0 0 16px 0;">
                                        <a href="${resetUrl}" 
                                           style="color: ${lightColors.primary}; font-size: 14px; text-decoration: underline; word-break: break-all;">
                                            ${resetUrl}
                                        </a>
                                    </p>
                                    <p style="color: ${lightColors.textSecondary}; font-size: 14px; line-height: 1.6; margin: 16px 0;">
                                        ${t('email.passwordReset.expiry')}
                                    </p>
                                    <p style="color: ${lightColors.textSecondary}; font-size: 14px; line-height: 1.6; margin: 16px 0 0 0;">
